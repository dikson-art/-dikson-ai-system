...
Статус: Memory, Wiki, Knowledge Graph, Semantic Search, Agent Framework, Task Queue, Planning System, Research Engine и Git Automation объединены в FastAPI MVP.
